...
public class OnlinePaymentTest {
    ...
    private void closeCookiePopup() {
        try {
            ...
            System.out.println("Куки окно не найдено");
        }
    }
    ...
    public void testPlaceholdersForAllServices() {
        ...
        for (String service : services) {
            System.out.println("Проверка услуги: " + service);
            selectService(service);
            String placeholder = getPlaceholder();
            System.out.println(service + " - Плейсхолдер: " + placeholder);
    ...
    private void fillPaymentForm(String phone, String amount) {
        try {
            ...
            System.out.println("Заполненные данные: Номер: " + phone + ", Сумма: " + amount + " руб");
        } catch (Exception e) {
    ...
    private void verifyPaymentForm() {
        try {
            ...
            System.out.println("Платежная форма успешно загружена");
    ...
    private void takeScreenshot() {
        try {
            // Простая реализация скриншота без Allure
            byte[] screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES);
            System.out.println("Скриншот сделан (размер: " + screenshot.length + " байт)");
        } catch (Exception e) {
